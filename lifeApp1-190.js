...
//            if (house_number) {
            console.log("house_number.val().length = "+house_number.val().length);
...
//            if (street) {
            console.log("street.val().length = "+street.val().length);
...
//            if (house_number && street) {
            if (house_number.val().length > 0 && street.val().length > 0) {
