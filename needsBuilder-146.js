$(document).ready(function() {
	...
	var	storage_dependent_spouse = storage.getItem('dependent_spouse'),
			...
			started_at_least_second_page_of_needs = false;

	if (storage_dependent_spouse !== null || storage_dependent_children !== null || storage_dependent_parent !== null || storage_dependent_other !== null) {
			started_at_least_second_page_of_needs = true;
	}

	if(commit_point !== null && commit_point !== "" && commit_point !== undefined && navigation_from !== "1-basics" && started_at_least_second_page_of_needs == true) {
