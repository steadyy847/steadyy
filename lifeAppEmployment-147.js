        ...
        if (other_income_detail) {
          $('#other_income_detail')
            ...
            .trigger('input'); // Assign the value and trigger input event
				...
				// After all Income Sources checkboxes have been set, validate everything the way it would if focus was moved away from field
				//-----------$income_sources.trigger('focusout')
			...
			function validateIncomeSources() {
			  ...
			  if (anyChecked) {
			    ...
			    income_sources_errors = false;
					...
					console.log("isOtherIncomeChecked = "+isOtherIncomeChecked);
					if (isOtherIncomeChecked) {
			    	$('#accordian-income-source-other-details').show(500);
						console.log("$('#other_income_detail').val() = "+$('#other_income_detail').val());
