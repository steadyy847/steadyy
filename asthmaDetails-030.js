...
//				}
    ...
    if (objectAffected == 'hospitalization_date') {
          ...
          console.log("Current field with focus is (ID) "+document.activeElement.id);
          console.log("Current field with focus is (Name) "+document.activeElement.name);
          console.log(objectAffected+"("+focusState+") | last_focus = "+last_focus);
					$("."+objectAffected+"_error").show(500);
          $(".page_error").hide(500);
