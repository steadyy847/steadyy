...
//				}
    ...
    if (objectAffected == 'attacks_per_year') {
      ...
      console.log("$attacks_per_year.val() = "+$attacks_per_year.val());
      console.log("$attacks_per_year.value = "+$attacks_per_year.value);
	    	if ($attacks_per_year.val().length > 0) {
					$("."+objectAffected+"_error").hide(500);
