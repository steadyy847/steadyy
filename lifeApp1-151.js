...
/*new*/       if (storage.key(i) != 'quote_email_address' && 
/*new*/           storage.key(i) != 'navigation_from' && 
/*new*/           storage.key(i) != 'fpestid_timestamp' && 
/*new*/           storage.key(i) != 'fpestid' && 
/*new*/           storage.key(i) != 'ms_groups')
/*new*/       {
