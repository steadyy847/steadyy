...
alert(suppress_return_visit_modal);
	if(commit_point !== null && commit_point !== "" && commit_point !== undefined && navigation_from !== "1-basics" && previously_started_needs_builder == true && suppress_return_visit_modal !== true) {
		alert("in true part of eval")
  ...
  storage.setItem('suppress_return_visit_modal', false);
