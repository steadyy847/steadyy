...
//			document.getElementById("needs-step").disabled = true;
			...
			needs_help_selected = $("input[name='needs_help']:checked").val();
console.log("Storage has been cleared.  $('input[name='needs_help']').is(':checked') = "+$("input[name='needs_help']").is(':checked'));
console.log("Storage has been cleared.  needs_help_selected = "+needs_help_selected);
...
//				$("#needs_help_" + needs_help_selected.toLowerCase()).parent().css( "backgroundColor", "#ffffff" );
				$("#needs_help_" + needs_help_selected.toLowerCase()).parent().css( "backgroundColor", "transparent" );
				...
				$("#needs_help_" + needs_help_selected.toLowerCase()).parent().css( "color", "#ffffff" );
				needs_help_selected = undefined;
needs_help_selected = $("input[name='needs_help']:checked").val();
console.log("Needs Help Button has been reset.  $('input[name='needs_help']').is(':checked') = "+$("input[name='needs_help']").is(':checked'));
console.log("Needs Help Button has been reset.  needs_help_selected = "+needs_help_selected);
			}
	}
