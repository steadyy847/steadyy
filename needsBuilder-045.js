...
$(document).ready(function() {
	...
	$('#home-step').click(function(e) {
		e.preventDefault();
		var home_ownership_checked = $("input[name='HomeOwnership']").is(':checked');
		console.log("home_ownership_checked = "+home_ownership_checked+"\n"+
								"home_ownership_selected = "+home_ownership_selected);
	...
	$('#debts-prev').click(function(e) {
		...
		if (home_ownership_selected == "No") {
			$('.w-round div:nth-child(6)').trigger('tap'); // Skip questions about mortgage, and go back to 'home ownership' page
		} else {
			$('.w-round div:nth-child(8)').trigger('tap');
		}
