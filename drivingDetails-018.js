...
console.log("moving_violations_selected = "+moving_violations_selected+"\n"+
						"$violations_last_6mo = "+$violations_last_6mo+"\n"+
						"$violations_last_year = "+$violations_last_year+"\n"+
						"$violations_last_2years = "+$violations_last_2years+"\n"+
						"$violations_last_3years = "+$violations_last_3years+"\n"+
						"$violations_last_5years = "+$violations_last_5years);
