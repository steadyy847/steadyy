...
function monthValuesCheck(thisValue) {
    console.log("thisValue="+thisValue+" | thisValue.length="+thisValue.length);
    if (thisValue.length == 2) {
      if (thisValue == 0) {
        console.log("IN THE IF CLAUSE WHERE thisValue ==0\n...thisValue="+thisValue+" | thisValue.length="+thisValue.length);
      }
      if (thisValue == 00) {
        console.log("IN THE IF CLAUSE WHERE thisValue ==00\n...thisValue="+thisValue+" | thisValue.length="+thisValue.length);
      }
    }
	  if (thisValue < 0) {
		  return null;}
