			...
			$(form).each(function() {
				...
				function removePolicy(i) {
					...
					console.log("remove policy "+i)
						...
						console.log("$('#other_carrier_1') = "+$('#other_carrier_1').val());
						console.log("$('#other_carrier_2') = "+$('#other_carrier_2').val());
						console.log("$('#other_carrier_3') = "+$('#other_carrier_3').val());
...
//						console.log("Next Policy Carrier (#other_carrier_"+(x+1)+") = "+$('#other_carrier_'+x+1).val());
/*
						$('#other_carrier_'+i).val("");
						$('#other_policy_num_'+i).val("");
						$('#other_policy_year_issued_'+i).val("");
