...
//      $app_phone_number.mask('(000) 000-0000');
      ...
      $app_phone_number.on('input.True', function () {
        console.log("$app_phone_number.val().length = "+$app_phone_number.val().length);
        console.log("this.value.length = "+this.value.length);
        if (this.value.length > 14) {
          console.log("About to slice a digit off because this.value.length > 14.  length = "+this.value.length);
          this.value = this.value.slice(0, 14);
          console.log("Done slicing a digit off because this.value.length was > 14.  Now length = "+this.value.length);
        }
      });
      ...
      function submitButtonCheck() {
        console.log("In the submitButtonCheck function. $app_phone_number.val().length = "+$app_phone_number.val().length);
        var storage = window.localStorage;
        if (
          $app_first_name.val() != '' &&
          $app_last_name.val() != '' &&
