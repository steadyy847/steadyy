...
$(document).ready(function () {
    ...
    if (window.location.search) {
        ...
        console.log('firstName query param = ' + firstName);
        if (firstName) {
            console.log("$('#app_first_name').val (BEFORE SETTING)= " + $('#app_first_name').val());
            $('#floating-first-name-label').addClass('float'); // If needed for floating label
            $('#app_first_name').val(decodeURIComponent(firstName)).trigger('input'); // Assign the value and trigger input event
            console.log("$('#app_first_name').val (AFTER SETTING)= " + $('#app_first_name').val());
        }
    } else {
  ...
  (function ($, window, document, undefined) {
    ...
    $(form).each(function () {
      ...
      //						$source_category = document.getElementById("source_category");
				...
				console.log("In the $(form).each(function () \n" +
