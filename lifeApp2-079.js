		      ...
		      if (window.location.search) {
		        ...
		        console.log('No query parameters found in the URL.');
					...
					function submitButtonCheck() {
						...
						console.log("employer.length = "+employer.length+"\n"+
												"occupation.length = "+occupation.length+"\n"+
												"personal_income.length = "+personal_income.length+"\n"+
				 								"household_income.length = "+ household_income.length+"\n"+
												"net_worth = "+net_worth+"\n"+
