...
$(document).ready(function () {
  Webflow.push(function () {
    $('#application').submit(function () {
        // Retrieve the parameters that were passed in the URL
        ...
        if (firstName != '' &&
            ...
            sourceCategory != '')
        {
       	location.href = '/saved-applications/a674d40058cc17c98c35977d1';
        } else {
          alert("didn't find query parms in URL, meaning that we didn't get here from the saved-applications page, so leave everything as is");
        }
