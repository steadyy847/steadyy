...
//	$('#commit_point').val("2-health");
  ...
  console.log("storage_license = "+storage_license+"\n"+
              "storage_height_feet = "+storage_height_feet+"\n"+
              "storage_height_inches = "+storage_height_inches+"\n"+
              "storage_weight = "+storage_weight+"\n"+
              "storage_tobacco = "+storage_tobacco+"\n"+
              "storage_asthma = "+storage_asthma+"\n"+
              "storage_cancer = "+storage_cancer+"\n"+
              "storage_depression = "+storage_depression+"\n"+
              "storage_diabetes = "+storage_diabetes+"\n"+
              "storage_heart_attack = "+storage_heart_attack+"\n"+
              "storage_sleep_apnea = "+storage_sleep_apnea+"\n"+
              "storage_stroke = "+storage_stroke+"\n"+
              "storage_no_conditions = "+storage_no_conditions);
  ...
  if (storage_no_conditions == null || storage+no_conditions === 'false') {
