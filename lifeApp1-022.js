	...
	submitButtonCheck();
				...
				$home_address.on('input.True', function() {
					if (this.value.length == 0) {
						...
						console.log("formattedAddress in input() = "+formattedAddress);
						$("#error-address").show(500);
	          $home_address.css("border-color", error_color);
					}
				});

				$home_address.on('focusout', function() {
					console.log("formattedAddress in focusout() = "+formattedAddress);
/*					if (formattedAddress == "") {
						$("#error-address").show(500);
	          $home_address.css("border-color", error_color);
					} else {
						$("#error-address").hide(500);
...
*/
				...
				function submitButtonCheck() {
					...
					console.log("formattedAddress in submitButtonCheck() = "+formattedAddress);
					if (formattedAddress == "") {
						$("#error-address").show(500);
	          $home_address.css("border-color", error_color);
					} else {
