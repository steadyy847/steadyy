...
console.log("storage_goal_income = "+storage_goal_income);
...
console.log("income_CB = "+income_CB+"\n"+
						"mortgage_CB = "+mortgage_CB+"\n"+
						"debts_CB = "+debts_CB+"\n"+
						"education_CB = "+education_CB+"\n"+
						"funeral_CB = "+funeral_CB+"\n"+
						"charity_CB = "+charity_CB);
