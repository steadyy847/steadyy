...
*/
				console.log("term="+term+" | company_code="+company_code);
				console.log("Number(term)="+Number(term)+" | company_code="+company_code);

				switch(Number(term)) {
					case 10:
						mixer10.filter('.'+company_code);
						break;
					case 15:
						mixer15.filter('.'+company_code);
						break;
					case 20:
						mixer20.filter('.'+company_code);
						break;
					case 25:
						mixer25.filter('.'+company_code);
						break;
					case 30:
						mixer30.filter('.'+company_code);
						break;
					default:
