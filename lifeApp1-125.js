  ...
  Webflow.push(function () {
    $('#application').submit(function () {
      ...
      if (window.location.search) {
        ...
        // If the URL has the saved_app query params, then reset the submitButton href to
				// take user back to the saved applications page, instead of onto app page 3
        if (savedApp != '') {
  ...
  (function ($, window, document, undefined) {
    ...
    $(form).each(function () {
      ...
      function submitButtonCheck() {
        ...
        console.log("First Name = "+$app_first_name.val()+"/n"+
                    "Last Name = "+$app_last_name.val()+"/n"+
                    "Home Address = "+$app_home_address.val()+"/n"+
                    "Formatted Address = "+formattedAddress+"/n"+
                    "Address Line 1 = "+$app_address_line1.val()+"/n"+
                    "City = "+$app_city.val()+"/n"+
                    "State = "+$app_state.val()+"/n"+
                    "Zip Code = "+$app_zip.val()+"/n"+
                    "Email Address = "+$app_email_address.val()+"/n"+
                    "Phone Number = "+$app_phone_number.val()+"/n"+
                    "Phone Number Length = "+$app_phone_number.val().length+"/n"+
                    "Source Category = "+$app_source_category.val()+"/n"+
                    "Source Category Length = "+$app_source_category.val().length);
