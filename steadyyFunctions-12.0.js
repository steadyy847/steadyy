...
//        if (state == "IL") {
    ...
    if (objectAffected == 'cigarette-date') {
    ...
    if (objectAffected == 'cigarette-amount') {
    ...
    if (objectAffected == 'cigar-amount') {
