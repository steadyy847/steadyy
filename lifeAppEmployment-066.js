			...
			function validateAnticipatedChanges() {
			  ...
			  if (anyChecked) {
					if (document.getElementById(this.id).checked) {
						$(this.id).prev('.w-checkbox-input').addClass('w--redirected-checked');
						$("input[id='"+thisObject.id+"']:checked").prop('checked', true);
					}
					else {
						$(this.id).prev('.w-checkbox-input').removeClass('w--redirected-checked');
			    ...
			    anticipated_changes_errors = false;
					...
					console.log("$(no_changes).prop('checked') = "+$(no_changes).prop('checked'));
