...
console.log("STORAGE: commit_point = "+commit_point);
...
//			$('#modal-alert-required').show(500);
			...
			return_visit_selected = $("input[name='return_visit']:checked").val();
			console.log("In modal button clicked () function | return_visit_selected = "+return_visit_selected);
...
//		storage.getItem('children_num')
    ...
    if (page == "modal") {
			...
			return_visit_selected = $("input[name='return_visit']:checked").val();
			console.log("In submitButtonCheck() function | return_visit_selected = "+return_visit_selected);
