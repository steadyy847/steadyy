...
for (var i = 0; i < riskClasses.length; i++) {
  var riskClass = riskClasses[i];
	...
	factors_evaluated_for_risk_classes = factors_evaluated_for_risk_classes + riskClass.name + " = " + riskClass.value + "<br>";
...
alert("The final risk class (taking the smallest value) is: " + smallestValue);
