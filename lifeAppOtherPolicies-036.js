  ...
  Webflow.push(function () {
    $('#application').submit(function () {
      ...
      if (window.location.search) {
        ...
        // If the URL has the saved_app query params and the user has already completed 4 steps, then reset the submitButton href
        // to take user back to the saved applications page, instead of onto app page 4 as if they were in normal flow
        if (savedApp && !isNaN(step) && step > 3) {
