...
$(document).ready(function () {
    ...
    if (window.location.search) {
        ...
        if (firstName) {
            ...
            $('#first_name').val(decodeURIComponent(firstName)).trigger('input'); // Assign the value and trigger input event
  ...
  (function ($, window, document, undefined) {
    ...
    $(form).each(function () {
      ...
      $first_name.on('focusin', function () {
				console.log("$first_name.val() = "+$first_name.val()+"\n"+
										"$first_name.val().length = "+$first_name.val().length);
			});
