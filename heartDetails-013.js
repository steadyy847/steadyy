		...
		(function($, window, document, undefined) {
          ...
          storage = window.localStorage;
            ...
            submit_errors = true,
				...
				if (numericPartOfCommitPoint > 9) {
					$('#commit_point').val(commitPointItem);
				} else {
					storage.setItem('commit_point', "9-heart-attack");
					$('#commit_point').val("9-heart-attack");
				}
				storage.setItem('navigation_from', "9-heart-attack");
  			...
  			var storage_diag_month = storage.getItem('heart_attack_diag_month'),
  					storage_diag_year = storage.getItem('heart_attack_diag_year'),
						...
						storage_episode_year = storage.getItem('heart_attack_episode_year'),
