  ...
  if (
    ...
    for (i = 0; i < storage.length; i++) {
      if (
        ...
        storage.key(i) != 'suppress_return_visit_modal' && // Internally created by Steadyy to keep track of the navigational path the user followed on our site, in case they go back to the Needs Builder from the App Summary page
