...
*/    
  ...
  var formData = {
		...
		health: health,
//		compinc: "AMGE,UTST,CINN,BANN,WILP,PACL,PROT,PROA,PRUC,PRUJ,SBLI,JOHU,JOHY,LNNA,LNLI", Removed UTST (AIG-NY) & WILP (William Penn-NY) & PROA (Protective-NY) & JOHY (John Hancock-NY) & LNLI (Lincoln Financial-NY) b/c TBI doesn't write with them
