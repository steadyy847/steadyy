	...
	(function($, window, document, undefined) {
      ...
      if (window.location.search) {
        ...
        console.log("Done pre-filling fields from query parameters found in the URL");
				...
				// After pre-filling the checkboxes from URL params, simulate a validation pass
				function runInitialCheckboxValidation() {
				  let anyChecked = false;
				    ...
				    if (!isChecked) {
				      switch (p.cbId) {
				        ...
				        case 'experience-bonds-CB':
				          ...
				          break;
				        case 'experience-other-CB':
				          // Leave to validateOtherExperience()
				          break;
				        default:
				          console.warn(`Unhandled checkbox ID during prefill validation: ${p.cbId}`);
				          break;
				      }
				    } else {
				      ...
				      switch (p.cbId) {
				        ...
				        case 'experience-bonds-CB':
				          ...
				          break;
				        case 'experience-other-CB':
				          // Let validateOtherExperience() handle this one
				          break;
				        default:
				          console.warn(`Unhandled checkbox ID during prefill validation: ${p.cbId}`);
				          break;
				...
				// Run initial error flag logic after setting all values
				runInitialCheckboxValidation();
				validateOtherExperience();
				submitButtonCheck();
