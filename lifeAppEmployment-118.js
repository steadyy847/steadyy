...
$(function() {
	...
	(function($, window, document, undefined) {
      ...
      if (window.location.search) {
        ...
        if (EmploymentStatus) {
					console.log('Getting ready to prefill - EmploymentStatus');
		        ...
		        if (employer) {
							console.log('Getting ready to prefill - employer');
		        ...
		        if (occupation) {
							console.log('Getting ready to prefill - occupation');
		        ...
		        if (employer_address) {
							console.log('Getting ready to prefill - employer_address');
		        ...
		        if (years_employed) {
							console.log('Getting ready to prefill - years_employed');
		        ...
		        if (personal_income) {
							console.log('Getting ready to prefill - personal_income');
		          $('#personal_income_label').addClass('float'); // Float the label
		          $('#personal_income')
		            .val(decodeURIComponent(personal_income))
		          //  .trigger('input'); // Assign the value and trigger input event
		        }

		        if (IncomeVariability) {
							console.log('Getting ready to prefill - IncomeVariability');
        ...
        if (household_income) {
          $('#household_income')
            .val(decodeURIComponent(household_income))
           // .trigger('input'); // Assign the value and trigger input event
        }
        ...
        if (living_expenses) {
          $('#living_expenses')
            .val(decodeURIComponent(living_expenses))
          //  .trigger('input'); // Assign the value and trigger input event
        }
        ...
        if (liquid_assets) {
          $('#liquid_assets')
            .val(decodeURIComponent(liquid_assets))
          //  .trigger('input'); // Assign the value and trigger input event
        }

        if (non_liquid_assets) {
          $('#non_liquid_assets')
            .val(decodeURIComponent(non_liquid_assets))
          //  .trigger('input'); // Assign the value and trigger input event
        }

        if (short_term_debts) {
          $('#short_term_debts')
            .val(decodeURIComponent(short_term_debts))
          //  .trigger('input'); // Assign the value and trigger input event
        }

        if (long_term_debts) {
          $('#long_term_debts')
            .val(decodeURIComponent(long_term_debts))
          //  .trigger('input'); // Assign the value and trigger input event
        }
        ...
        if (Bankruptcy) {
				...
				isPrefilling = false;
				$("input[name='EmploymentStatus']").trigger('change');
      ...
      $installment_debt.mask('000%', { reverse: true });
			...
			$("input[name='EmploymentStatus']").click(function(e) {
			  if (isPrefilling) return; // Suppress validation if prefilling

				console.log('Validation triggered on EmploymentStatus clicked event');
				var employment_status_selected = $("input[name='EmploymentStatus']:checked").val();
				if (employment_status_selected == "Employed") {
					$(".employment-details").show(500);
				} else if (employment_status_selected == "Unemployed") {
...
/*
			$employment_info.on('change', function() {
			  if (isPrefilling) return; // Suppress validation if prefilling
				...
				console.log("Validation triggered on $employment_info.on('change') event");
				var employment_status_selected = $("input[name='EmploymentStatus']:checked").val();
...
*/
			$employment_info.on('focusout', function() {
			  if (isPrefilling) return; // Suppress validation if prefilling
				...
				console.log("Validation triggered on $employment_info.on('focusout') event");
				var employment_status_selected = $("input[name='EmploymentStatus']:checked").val();
				if (employment_status_selected != null) {
					if (employment_status_selected == "Employed") {
						if (!employment_info_satisfied) {
			...
			$employer.on('input focusout', function() {
				console.log("Validation triggered on $employer.on('input focusout') event");
			...
			$occupation.on('input focusout', function() {
				console.log("Validation triggered on $occupation.on('input focusout') event");
			...
			$years_employed.on('change focusout', function() {
				console.log("Validation triggered on $years_employed.on('change focusout') event");
      ...
      $employer_address.on('input.True', function () {
				console.log("Validation triggered on $employer_address.on('input') event");
        ...
        submitButtonCheck();
			...
			$employer_address.on('focusout', function () {
				console.log("Validation triggered on $employer_address.on('focusout') event");
			...
			$personal_income.on('input', function () {
				console.log("Validation triggered on $personal_income.on('input') event");
			...
			$personal_income.on('focusout', function () {
				console.log("Validation triggered on $personal_income.on('focusout') event");
			  validatePersonalIncome();
			});
			...
			$income_variability.on('change focusout', function() {
				console.log("Validation triggered on $income_variability.on('change focusout') event");
