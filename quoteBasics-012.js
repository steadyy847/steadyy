...
//	storage.setItem('quote_initiated_from_city', document.getElementById("quote_initiated_from_city").value);
//	storage.setItem('quote_initiated_from_ip_address', document.getElementById("quote_initiated_from_ip_address").value);
