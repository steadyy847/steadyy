  ...
  (function ($, window, document, undefined) {
    ...
    $(form).each(function () {
      ...
      $past_replacements.on('change', function () {
        ...
        if (past_replacements_selected != null) {
          ...
          if (past_replacements_selected == 'No') {
            ...
            console.log("In the 'Yes' part of $past_replacements.on('change') function. $past_replacements_explanation.val().length = " + $past_replacements_explanation.val().trim().length);
      ...
      $past_replacements_explanation.on('input', function () {
        const value = $past_replacements_explanation.val().trim();
        console.log("In the $past_replacements_explanation.on('input') function. $past_replacements_explanation.val().length = " + value.length);
        if (value.length > 0) {
          hideError($('#error-emergency-past-replacements-required'));
          $past_replacements_explanation.css('border-color', no_error_color);
          past_replacements_errors = false;
        } else {
          showError($('#error-past-replacements-explanation-required'));
