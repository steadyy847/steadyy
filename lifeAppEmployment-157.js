...
function onPlaceChanged() {
  ...
  // Set focus back to the employer_address field when the user selects an address with their mouse.
  setTimeout(function() {
...
$(function() {
	...
	(function($, window, document, undefined) {
      ...
      $employer_address.on('input', function () {
		          ...
		          $('#employer_address')
		            ...
		            .trigger('input'); // Assign the value and trigger input event
						  ...
						  const runParse = function () {
						    ...
						    console.log("Running parseAddress for employer_address:", decoded);
						    parseAddress(decoded, function () {
						      console.log("Done parsing employer_address");
						      submitButtonCheck();
						    });
						  };
