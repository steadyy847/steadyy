...
var riskClasses =  [citizenship_risk_class, 
										driving_risk_class, 
										tobacco_risk_class, 
										bmi_risk_class, 
										cancer_risk_class, 
...
// create an object with the ranking of the values, with 'nt4' being the highest and 'nt1' being the lowest
var riskRanking = {'nt4': 6, 'nt3': 5, 'nt2': 4, 'nt1': 3, 'smoke1': 2, 'smoke2': 1};
...
for (var i = 0; i < riskClasses.length; i++) {
  var riskClass = riskClasses[i];
	console.log("riskClass["+i+"]="riskClass+"; also ="+riskRanking[riskClass]);
