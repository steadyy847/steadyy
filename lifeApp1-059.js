...
if (window.location.search) {
  ...
  if (firstName) {
    ...
    if (firstNameField) {
      console.log(
        'firstNameField.value (BEFORE SETTING) = ' + firstNameField.value
      );
      firstNameField.value = decodeURIComponent(firstName); // Assign the value
      console.log(
        'firstNameField.value (AFTER SETTING) = ' + firstNameField.value
      );

      console.log(
        $("'#first_name').val (BEFORE SETTING)= " + $('#first_name').value)
      );
      $('#first_name').val(decodeURIComponent(firstName));
      $('#floating-first-name-label').addClass('float');
      console.log(
        $("'#first_name').val (AFTER SETTING)= " + $('#first_name').value)
      );
    } else {
