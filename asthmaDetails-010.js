Webflow.push(function(){
  $("#quote").submit(function(){
	...
	$(function() {
      ...
      console.log("storage_attacks_per_year="+storage_attacks_per_year+"\n"+
                  "storage_hosp_past_yr="+storage_hosp_past_yr+"\n"+
                  "storage_hosp_total="+storage_hosp_total);

			if (storage_attacks_per_year !== null && storage_attacks_per_year !== "") {
        console.log("In the conditional check for storage_attacks_per_year !== null; storage_attacks_per_year="+storage_attacks_per_year);
//				$attacks_per_year.val(storage_attacks_per_year);
//				$attacks_per_year.val(parseInt(storage_attacks_per_year));
        ...
        console.log("In the conditional check for storage_hosp_past_yr !== null; storage_hosp_past_yr="+storage_hosp_past_yr);
//				$hosp_past_yr.val(parseInt(storage_hosp_past_yr));
        document.getElementById("asthma_hosp_past_yr").value = storage_hosp_past_yr;
			}

			if (storage_hosp_total !== null && storage_hosp_total !== "") {
        console.log("In the conditional check for storage_hosp_total !== null; storage_hosp_total="+storage_hosp_total);
//				$hosp_total.val(parseInt(storage_hosp_total));
...
*/
      ...
      console.log("In the submitButtonCheck() function\n"+
                  "storage_attacks_per_year="+storage_attacks_per_year+"\n"+
                  "storage_hosp_past_yr="+storage_hosp_past_yr+"\n"+
                  "storage_hosp_total="+storage_hosp_total);

      console.log("In the submitButtonCheck() function\n"+
                  "document.getElementById('asthma_attacks_per_year').value="+document.getElementById("asthma_attacks_per_year").value+"\n"+
                  "document.getElementById('asthma_hosp_past_yr').value="+document.getElementById("asthma_hosp_past_yr").value+"\n"+
                  "document.getElementById('asthma_hosp_total').value="+document.getElementById("asthma_hosp_total").value);
