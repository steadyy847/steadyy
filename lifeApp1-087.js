...
$(function () {
  (function ($, window, document, undefined) {
    ...
    $(form).each(function () {
      ...
      console.log("In the form.each function, right before initializing google.mapsplaces. formattedAddress = "+formattedAddress);
      ...
      $app_home_address.on('input.True', function () {
        console.log("In the $app_home_address input function.\nthis.value.length = "+this.value.length);
        if (this.value.length == 0) {
          formattedAddress = '';
          house_number = '';
          street = '';
      ...
      $app_home_address.on('focusout', function () {
        console.log("In the $app_home_address focusout function.\n"+
                    "$app_home_address.val().length = "+$app_home_address.val().length+"\n"+
      ...
      if (window.location.search) {
          ...
          if (homeAddress) {
              ...
              console.log("formattedAddress right before calling parseAddress function = "+formattedAddress);
              // Call the function with the formatted address
              parseAddress(decodeURIComponent(formattedAddress));
              console.log("formattedAddress right after returning from call to parseAddress function = "+formattedAddress);
          }
          if (phoneNumber) {
      ...
      function parseAddress(formattedAddress) {
        ...
        geocoder.geocode({ address: formattedAddress }, function(results, status) {
          if (status === "OK" && results[0]) {
            ...
            console.log("BEFORE looping thru address to parse components:\n"+
                        "formattedAddress = "+formattedAddress+"\n"+
                        "app_house_number = "+$('#app_house_number').val()+"\n"+
                        "app_street = "+$('#app_street').val()+"\n"+
                        "app_address_line1 = "+$('#app_address_line1').val()+"\n"+
                        "app_address_line2 = "+$('#app_address_line2').val()+"\n"+
                        "app_city = "+$('#app_city').val()+"\n"+
            ...
            console.log("AFTER looping thru address to parse components:\n"+
                        "formattedAddress = "+formattedAddress+"\n"+
                        "app_house_number = "+$('#app_house_number').val()+"\n"+
                        "app_street = "+$('#app_street').val()+"\n"+
                        "app_address_line1 = "+$('#app_address_line1').val()+"\n"+
