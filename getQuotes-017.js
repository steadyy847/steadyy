...
*/    
  ...
  var formData = {
		...
		health: health,
//		compinc: "AMGE,UTST,CINN,BANN,WILP,PACL,PROT,PROA,PRUC,PRUJ,SBLI,JOHU,JOHY,LNNA,LNLI", Removed UTST (AIG-NY) & WILP (William Penn-NY) b/c TBI doesn't write with them
		compinc: "AMGE,CINN,BANN,PACL,PROT,PROA,PRUC,PRUJ,SBLI,JOHU,JOHY,LNNA,LNLI",
		newcategory: "Z:34567",
