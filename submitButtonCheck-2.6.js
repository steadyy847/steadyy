	function submitButtonCheck(document, form, this, page, height_errors, weight_errors, conditions_errors) {
...
//				weight_valid_error = false,
  	...
  	if (page == "conditions") {
			...
			if (document.getElementById(this.id).checked) {
				...
				$("input[id='"+this.id+"']:checked").prop('checked', false);
			}
			if (this.name.slice(0,9) == "Condition") {
				if (no_conditions_CB) {
