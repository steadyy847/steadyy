...
console.log("Initializing on pageLoad.  storage_other_details = "+storage_other_details);
...
//  				$other_details.val(storage_other_details);
          document.getElementById("other_details").value = storage_other_details;
  			}
        console.log("$other_details.val() = "+$other_details.val());
        console.log("$other_details.value = "+$other_details.value);
				submitButtonCheck();
...
console.log("In submitButtonCheck() function.  other_details = "+other_details);
