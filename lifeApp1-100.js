...
console.log("before initiatilizing autocomplete input and clearing all fields.\n"+
...
console.log("in the placeChanged function, have house num and street, but before setting address_line1.\n"+
            "address_line1 = "+address_line1+"\n"+
            "$app_address_line1.val() = "+$app_address_line1.val());
...
console.log("at end of placeChanged function, checking that all subfields are full before clearing or clearing errors.\n"+
            "address_line1 = "+address_line1+"\n"+
            "$app_address_line1.val() = "+$app_address_line1.val());
        if (
          formattedAddress != '' &&
...
console.log("in the $app_home_address.on('input.True') function.\n"+
            " address_line1 = "+address_line1+"\n"+
            "$app_address_line1.val() = "+$app_address_line1.val());
...
console.log("in focusout function of home address.\n"+
            " address_line1 = "+address_line1+"\n"+
            "$app_address_line1.val() = "+$app_address_line1.val());
      ...
      function parseAddress(formattedAddress) {
        ...
        geocoder.geocode({ address: formattedAddress }, function(results, status) {
          if (status === "OK" && results[0]) {
            ...
            console.log("in the parseAddress() function after getting response from google but before evaluating results.\n"+
                        "address_line1 = "+address_line1+"\n"+
                        "$app_address_line1.val() = "+$app_address_line1.val());
            // Loop through address components to find the postal code, state, and city
            ...
            if (house_number && street) {
console.log("in the parseAddress() function, have house num and street, but before setting address_line1.\n"+
            "address_line1 = "+address_line1+"\n"+
            "$app_address_line1.val() = "+$app_address_line1.val());
              address_line1 = house_number + ' ' + street;
              document.getElementById('app_address_line1').value = address_line1;
              storage.setItem('app_address_line1', address_line1);
console.log("in the parseAddress() function, after setting address_line1.\n"+
            "address_line1 = "+address_line1+"\n"+
            "$app_address_line1.val() = "+$app_address_line1.val());
            submitButtonCheck();
            }
