		...
		(function($, window, document, undefined) {
			...
			$(form).each(function() {
				...
				function checkAdditionalPolicyDetails() {
					...
					console.log("Entering the checkAdditionalPolicyDetails() function\n"+
											"other_policy_ct = "+other_policy_ct+"\n"+
...
*/
					console.log("conditionals_for_policy1_satisfied = "+conditionals_for_policy1_satisfied);
					console.log("conditionals_for_policy2_satisfied = "+conditionals_for_policy2_satisfied);
					console.log("conditionals_for_policy3_satisfied = "+conditionals_for_policy3_satisfied);
					console.log("conditionals_for_policy4_satisfied = "+conditionals_for_policy4_satisfied);
					console.log("conditionals_for_policy5_satisfied = "+conditionals_for_policy5_satisfied);
