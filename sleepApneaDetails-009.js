...
/* STEP 4 - Set up listeners on each field for input events & validate all date entry fields */
  			...
  			$('form').on('keyup', 'input, select, textarea', function() {
				...
				$('#oxygen_saturation').on('input.True', function() {
					console.log("Oxygen Saturation: this.value.length = "+this.value.length+" | this.value = "+this.value);
				...
				$('#ahi').on('input.True', function() {
					console.log("AHI: this.value.length = "+this.value.length+" | this.value = "+this.value);
				  if (this.value.length == 3) {
						if (this.value > 100) {
							this.value = this.value.slice(0, 1);
							console.log("this.value was > 100, so trimmed it to "+this.value);
				...
				$('#apnea_index').on('input.True', function() {
					console.log("Apnea Index: this.value.length = "+this.value.length+" | this.value = "+this.value);
				  if (this.value.length == 3) {
						if (this.value > 100) {
							this.value = this.value.slice(0, 1);
							console.log("this.value was > 100, so trimmed it to "+this.value);
				...
				$('#rdi').on('input.True', function() {
					console.log("RDI: this.value.length = "+this.value.length+" | this.value = "+this.value);
				  if (this.value.length == 3) {
						if (this.value > 100) {
							this.value = this.value.slice(0, 1);
							console.log("this.value was > 100, so trimmed it to "+this.value);
