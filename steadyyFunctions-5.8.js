...
function AddZero(num) {
	...
	function checkDOB(document) {
        ...
        coverage_rec,
  			...
  			dob_error_req = true,
	  		dob_error_age = false,
		  	$annual_income = document.find('input[id="annual_income"]'),
...
//			$document.getElementById("dob").value = dob;
    ...
    console.log("Inside of checkDOB function. coverage_rec="+coverage_rec);
    
//		$document.getElementById("dob").value = dob;
//		$document.getElementById("age").value = adj_age;
    return [dob, adj_age, dob_error_req, dob_error_age, coverage_rec];
