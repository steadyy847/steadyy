...
//		modalObject.css('display', 'flex');
		modalObject.addClass('modal-entrance');
...
//	  					nextPage = "/life-insurance-application";
	  					nextPage = "/quote-results";		// even though the user previously navigated to the application page, take them back to quote so they can reconfirm which option they want
			      	break;
						default:
							nextPage = "ERROR";
