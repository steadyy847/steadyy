...
//            const formElement = document.querySelector('form');
            const formElement = document.querySelector('application_form');
            if (formElement) {
              const currentUrl = formElement.action;
              console.log("Original form action = " + currentUrl);

              // Update the form action to a new URL
              formElement.action = 'https://example.com/saved-applications';
              console.log("Updated form action = " + formElement.action);
            } else {
              console.log("Cannot get formElement for 'application' from document.querySelector");
            }
