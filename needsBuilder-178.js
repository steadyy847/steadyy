$(document).ready(function() {
	...
	if(commit_point !== null && commit_point !== "" && commit_point !== undefined && navigation_from !== "1-basics" && navigation_from !== "14-application" && previously_started_needs_builder == true && !suppress_return_visit_modal) {
	...
	function setPageValues() {
	  ...
	  if (storage_college_type_preference !== null) {
		...
		if (numericPartOfCommitPoint >= 1) {
				console.log("Since user is past the '0-needs' commit point, setting focus to the 'NeedsBuilder Summary' page");
