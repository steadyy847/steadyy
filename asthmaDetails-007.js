  ...
  $("#quote").submit(function(){
	...
	$(function() {
      ...
      console.log("storage_attacks_per_year="+storage_attacks_per_year+"\n"+
        ...
        console.log("In the conditional check for storage_attacks_per_year !== null");
        ...
        console.log("In the conditional check for storage_hosp_past_yr !== null");
				$hosp_past_yr.val(parseInt(storage_hosp_past_yr));
			}

			if (storage_hosp_total !== null && storage_hosp_total !== "") {
        console.log("In the conditional check for storage_hosp_total !== null");
