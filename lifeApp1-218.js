...
function onPlaceChanged() {
  ...
  if (
    ...
    console.log("Good Formatted Address with all requisite parts")
    ...
    // Evaluate whether the state of the address the user entered is one of the states that we are licensed to write coverage in, or not
      ...
      console.log("Valid Licensed State")
      ...
      console.log("Invalid State - Not Licensed Here")
      homeAddressInLicensedState = false;
    ...
    console.log("Address missing at least one of the parts, could be an intersection, neighborhood or city only");
    ...
    console.log("FALLTHRU - Address isn't good. Missing formattedAddress from return from Places API");
  }
