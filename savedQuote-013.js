$(document).ready(function() {
	...
	parseField(health_profile_body_type); // health_profile_body_type has three components: height_feet;height_inches;weght
...
// Add delay to ensure storage is populated so any times the getQuotes function needs to read from storage, we can ensure the data is there before reading
setTimeout(function() {
	getQuotes(document);
}, 100); // 100 milliseconds delay
