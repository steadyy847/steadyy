	...
	$(function() {
		...
		(function($, window, document, undefined) {
            ...
            hospitalization_date_errors = false;
				...
				if (numericPartOfCommitPoint > 5) {
					$('#commit_point').val(commitPointItem);
				} else {
					storage.setItem('commit_point', "5-asthma");
					$('#commit_point').val("5-asthma");
				}
				storage.setItem('navigation_from', "5-asthma");
