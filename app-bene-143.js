...
console.log("conditionals_for_primary_bene_satisfied = "+conditionals_for_primary_bene_satisfied);
...
function validateTotalAllocation() {
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    const alloc = parseInt(allocRaw, 10) || 0;
      ...
      console.log(`#additional_primary_bene_${i}`);
...
console.log("allocationTotalComplete BEFORE evaluating total allocation = "+allocationTotalComplete);
  if (total !== 100) {
