...
//			depression_meds = storage.getItem('depression_medications'),
	...
	if (JSON.parse(depression)) {
			years_since_depression_diag = dateDiff(orig_depression_diag, todayDate);
			console.log("orig_depression_diag="+orig_depression_diag);

			if (depression_current_treatment == 'Yes') {
					console.log("Currently in Treatment");
					...
					if ( depression_current_treatment == 'No' ) {
							...
							if ( depression_past_treatment == 'Yes') {
									...
									console.log("past_treatment_end_date="+past_treatment_end_date);
...
console.log("treatent_duration_in_years="+treatent_duration_in_years);

			if (depression_diagnosis != "Severe" && depression_hospitalization == 'No') {
					switch(true) {
						case (depression_medications_num == 0 && treatent_duration_in_years < 1):
							depression_risk_class = 'nt1';
							break;
					...
					depression_risk_class = 'refer';
					console.log("diagnosis="+depression_diagnosis+" & hospitalization="+depression_hospitalization);
			}
console.log("depression_risk_class="+depression_risk_class);
			alert("check console");
	}
