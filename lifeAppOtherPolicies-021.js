...
function submitButtonCheck() {
	...
	console.log("In top of submitButtonCheck() - past_replacements_errors = ")+past_replacements_errors;
      ...
      document.getElementById('submit_button').disabled = true;
			...
			$past_replacements.on('change', function() {
			  const past_replacements_selected = $("input[name='PastReplacements']:checked").val();
				console.log("On change - past_replacements_selected = "+past_replacements_selected);
			  if (past_replacements_selected != null) {
				  ...
				  $past_replacements.css("border-color", no_error_color);
					if (past_replacements_selected == "No") {
					  ...
					  setTimeout(function() {
						...
						console.log("In the place when past_replacements_errors just got set.  It = "+past_replacements_errors);
				...
				console.log("In bottom of $past_replacements.on('change') - past_replacements_errors = "+past_replacements_errors);
		      ...
		      const past_replacements_selected = $("input[name='PastReplacements']:checked").val();
			    ...
			    if (!$(document.activeElement).closest('#past-replacements').length) {
			      if (past_replacements_selected != null) {
			        ...
			        if (past_replacements_selected === "Yes" && $past_replacements_explanation.val().trim().length === 0) {
			          past_replacements_errors = true;
			        } else {
			          past_replacements_errors = false;
			        }
					...
					console.log("past_replacements_selected = "+past_replacements_selected+"\n"+
											"$past_replacements_explanation.val().trim().length = "+$past_replacements_explanation.val().trim().length+"\n"+
											"In bottom of $past_replacements.on('focusout') - past_replacements_errors = "+past_replacements_errors
					);
