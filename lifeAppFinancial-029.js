...
$(function() {
	...
	(function($, window, document, undefined) {
      ...
      document.getElementById('submit_button').disabled = true;
        ...
        console.log("In the $financial_products_experience.on('change') function");
			  const id = this.id;
          ...
          console.log("Within the $financial_products_experience.on('change') function || No Experience is checked");
			    // Uncheck the others
		      ...
		      // At least one of the Top 6 checkboxes of products the user has experience with is checked
			    ...
			    if (anyTopChecked) {
            console.log("Within the $financial_products_experience.on('change') function || One of Top 6 checkboxes are checked");
            ...
            console.log("Within the $financial_products_experience.on('change') function || None of the dependent fields was checked");
        ...
        console.log("In the validateFinancialProductsExperience() function. id pass in was: "+id);
          ...
          console.log("Within the validateFinancialProductsExperience() function || No Experience is checked");
			    // Uncheck the others
			    dependentFields.forEach(fieldId => {
			      $('#' + fieldId).prop('checked', false);
			      $('#' + fieldId).prev('.w-checkbox-input').removeClass('w--redirected-checked');
		      ...
		      // At least one of the Top 6 checkboxes of products the user has experience with is checked
			    ...
			    if (anyTopChecked) {
            console.log("Within the validateFinancialProductsExperience() function || One of the dependent fields was just checked");
				    // For those that are checked, show the input field to indicate how many years the user has experience with that product
						checkedFields.forEach(fieldId => {
						  switch (fieldId) {
						    case 'experience-life-insurance-CB':
...
/*		    } else {
            console.log("Within the validateFinancialProductsExperience() function || None of the dependent fields was checked");
			      // None of the top 6 are checked
			      $('#conditional-years-experience-life-insurance').hide(500);
			      $('#conditional-years-experience-fixed-annuities').hide(500);
			      $('#conditional-years-experience-variable-annuities').hide(500);
