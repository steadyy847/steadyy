...
//	console.log("objectAffected="+objectAffected+"\nfocusState="+focusState); // Use for debugging
    ...
    if (objectAffected == 'zip') {
        ...
        if (last_focus == "tobacco") {chkErrors('tobacco', 'focusout', $tobacco, $form);}
        if (last_focus == "license") {chkErrors('license', 'focusout', $license, $form);}
    } else if (objectAffected == 'weight') {
        $weight_div.css("border-color", "black");
        if (last_focus == "height") {chkErrors('height', 'focusout', $height_feet, $form);}
        if (last_focus == "tobacco") {chkErrors('tobacco', 'focusout', $tobacco, $form);}
        if (last_focus == "license") {chkErrors('license', 'focusout', $license, $form);}
    } else {
