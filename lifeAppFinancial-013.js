          ...
          // if there is something selected in this field, clear the error message
			...
			$financial_products_experience.on('focusout', function () {
			  ...
			  financialProductsFocusTimer = setTimeout(() => {
			    ...
			    if (!stillInside) {
						console.log("life_insurance_experience = "+life_insurance_experience);
						console.log("fixed_annuities_experience = "+fixed_annuities_experience);
						console.log("variable_annuities_experience = "+variable_annuities_experience);
						console.log("stocks_experience = "+stocks_experience);
						console.log("bonds_experience = "+bonds_experience);
						console.log("other_experience = "+other_experience);
