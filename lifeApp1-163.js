...
console.log(`User is using: ${getBrowserInfo()}`);
...
$(function () {
  (function ($, window, document, undefined) {
    ...
    $(form).each(function () {
      ...
      window.addEventListener('appData', (event) => {
          console.log("Received data from the JavaScript Events. First Name = "+event.detail.first_name); // Access passed data
      });
