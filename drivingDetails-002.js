...
/* STEP 4 - Set up listeners on each field for input events & validate all date entry fields */
			...
			$last_drunk_driving_date.on('focusin', function() {
					last_drunk_driving_date_errors = chkDrivingDetailErrors('last_drunk_driving_date', 'focusin', $last_drunk_driving_date, $form, last_focus);
			...
			$last_reckless_driving_date.on('focusin', function() {
					last_reckless_driving_date_errors = chkDrivingDetailErrors('last_reckless_driving_date', 'focusin', $last_reckless_driving_date, $form, last_focus);
			...
			$last_suspension_date.on('focusin', function() {
					last_suspension_date_errors = chkDrivingDetailErrors('last_suspension_date', 'focusin', $last_suspension_date, $form, last_focus);
			...
			$violations_last_6mo_wrapper.on('focusin', function() {
					violations_last_6mo_errors = chkDrivingDetailErrors('violations_last_6mo', 'focusin', $violations_last_6mo_wrapper, $form, last_focus);
					last_focus = "violations_last_6mo";
			});

			$violations_last_year_wrapper.on('focusin', function() {
					violations_last_year_errors = chkDrivingDetailErrors('violations_last_year', 'focusin', $violations_last_year_wrapper, $form, last_focus);
					last_focus = "violations_last_year";
			});

			$violations_last_2years_wrapper.on('focusin', function() {
					violations_last_2years_errors = chkDrivingDetailErrors('violations_last_2years', 'focusin', $violations_last_2years_wrapper, $form, last_focus);
					last_focus = "violations_last_2years";
			});

			$violations_last_3years_wrapper.on('focusin', function() {
					violations_last_3years_errors = chkDrivingDetailErrors('violations_last_3years', 'focusin', $violations_last_3years_wrapper, $form, last_focus);
					last_focus = "violations_last_3years";
			});

			$violations_last_5years_wrapper.on('focusin', function() {
					violations_last_5years_errors = chkDrivingDetailErrors('violations_last_5years', 'focusin', $violations_last_5years_wrapper, $form, last_focus);
