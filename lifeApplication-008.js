...
Webflow.push(function(){
	...
	$('#remove_policy_1').click(function(e) {
		e.preventDefault();
		console.log("other_insurance_selected (before update) = "+$("input[name='OtherLifeInsurance']:checked").val());
	  $("input[name='needs_help'][value='Yes']").prop("checked", false);
		$("input[name='needs_help'][value='Yes']").prev('.w-radio-input').removeClass('w--redirected-checked');

	  $("input[name='needs_help'][value='No']").prop("checked", true);
		$("input[name='needs_help'][value='No']").prev('.w-radio-input').addClass('w--redirected-checked');
		console.log("other_insurance_selected (after update) = "+$("input[name='OtherLifeInsurance']:checked").val());
	...
	$('#remove_policy_2').click(function(e) {
		...
		console.log("other_insurance_selected = "+other_insurance_selected);
		$("input[name='OtherLifeInsurance']:checked").val() = "No";
