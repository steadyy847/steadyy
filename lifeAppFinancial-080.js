...
function validateFinancialProductsExperienceCheckboxes() {
    ...
    if (!isChecked) {
      switch (p.cbId) {
        ...
        case 'experience-other-CB':
          // Let validateOtherExperience() handle this
          break;
        default:
          console.warn(`Unhandled checkbox ID during validation: ${p.cbId}`);
          break;
      }
    } else {
