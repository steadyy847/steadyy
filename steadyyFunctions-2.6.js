function chkErrors(objectAffected, focusState, object, $form, last_focus) {
    ...
    if (objectAffected == 'income') {
		...
		if (objectAffected == 'weight') {
			if (object.val().length > 1 && object.val().length < 4) {
				$("."+objectAffected+"_error").hide(500);
				$("."+objectAffected+"_error_validity").hide(500);
    ...
    if (objectAffected == 'conditions') {
        console.log("In the 'conditions' objectAffected section");
        console.log("Asthma="+asthma_CB+"\n"+
                    "Depression="+depression_CB+"\n"+
                    "Heart Attack="+heart_attack_CB+"\n"+
                    "Stroke="+stroke_CB+"\n"+
                    "Cancer="+cancer_CB+"\n"+
                    "Sleep Apnea="+sleep_apnea_CB+"\n"+
                    "Diabetes="+diabetes_CB+"\n"+
                    "No Conditions="+no_conditions_CB
                   );
