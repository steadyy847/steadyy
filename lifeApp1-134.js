  ...
  (function ($, window, document, undefined) {
    ...
    $(form).each(function () {
      ...
      $app_phone_number.on('input.True', function () {
        console.log("In the input function of Phone Number\n"+
                    "Phone Number = "+this.value+"\n"+
                    "Phone Number Length = "+this.value.length);
        if (this.value.length > 14) {
          console.log("In the slice section because this.value.length > 14.  length = "+this.value.length);
      ...
      $app_phone_number.on('input.True', function () {
        console.log("In Input of Phone Number function \n"+
                    "Phone Number = "+this.value+"\n"+
                    "Phone Number Length = "+this.value.length);
      ...
      $app_phone_number.on('focusout', function () {
        console.log("In FocusOut of Phone Number function \n"+
