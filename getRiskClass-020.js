...
// Evaluate Cancer History
	...
	if (cancer) {years_since_cancer_diag = dateDiff(orig_cancer_diag, todayDate);}

	if (cancer && (cancer_type == 'Basal' || cancer_type == 'Squamous') && years_since_cancer_diag > 1) {
...
// Evaluate Heart Attack History
	...
	console.log("heart_attack="+heart_attack);
	if (heart_attack) {years_since_heart_attack = dateDiff(last_heart_attack, todayDate);}

	if (heart_attack && years_since_heart_attack > 0.5) {
