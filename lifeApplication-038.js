...
// START FOR TESTING A NEW BUNCH OF LOGIC ----------
			...
			if (other_insurance_selected == "Yes") {
					...
					for (let i = 1; i < other_policy_ct+1; i++) {
						console.log("------ POLICY #"+i+" ------");
						console.log("other_carrier_"+i+" ="+$('#other_carrier_'+i).val()+"/n"+
												"other_policy_num_"+i+" ="+$('#other_policy_num_'+i).val()+"/n"+
												"other_policy_year_issued_"+i+" ="+$('#other_policy_year_issued_'+i).val()+"/n"+
												"other_policy_coverage_amt_"+i+" ="+$('#otother_policy_coverage_amt_her_carrier_'+i).val()+"/n"+
												"policy-"+i+"-replacement-flag ="+$("input[name='policy-"+i+"-replacement-flag']").val()
						);
						if ( $('#other_carrier_'+i).val() != ''
							&& $('#other_policy_num_'+i).val() != ''
							&& $('#other_policy_year_issued_'+i).val() != ''
							&& $('#other_policy_coverage_amt_'+i).val() != ''
							&& $("input[name='policy-"+i+"-replacement-flag']").val() != null
						) {
							switch (i) {
