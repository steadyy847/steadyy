...
$(document).ready(function () {
    ...
    if (window.location.search) {
        ...
        if (firstName) {
            $('#floating-first-name-label').addClass('float'); // Float the label
            $('#app_first_name').val(decodeURIComponent(firstName)).trigger('input'); // Assign the value and trigger input event
        }
        if (lastName) {
            $('#floating-last-name-label').addClass('float'); // Float the label
            $('#app_last_name').val(decodeURIComponent(lastName)).trigger('input'); // Assign the value and trigger input event
        }
				console.log("phoneNumber = "+phoneNumber);
        if (phoneNumber) {
            $('#floating-phone-number-label').addClass('float'); // Float the label
						console.log("Decoded phoneNumber = "+decodeURIComponent(phoneNumber));
            $('#app_phone_number').val(decodeURIComponent(phoneNumber)).trigger('input'); // Assign the value and trigger input event
        }
				console.log("emailAddress = "+emailAddress);
        if (emailAddress) {
            $('#floating-email-address-label').addClass('float'); // Float the label
						console.log("Decoded emailAddress = "+decodeURIComponent(emailAddress));
...
console.log("$app_phone_number.val() BEFORE setting mask = "+$app_phone_number.val());
      $app_phone_number.mask('(000) 000-0000');
console.log("$app_phone_number.val() AFTER setting mask = "+$app_phone_number.val());
