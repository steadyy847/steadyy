...
//        $zip_div.css("border-color", "black");
        ...
        if (last_focus == "diagnosis_severity") {chkErrors('diagnosis_severity', 'focusout', $diagnosis_severity, $form, last_focus);}
        if (last_focus == "past_treatment") {chkErrors('past_treatment', 'focusout', $past_treatment, $form, last_focus);}
    } else if (objectAffected == 'diagnosis_severity') {
        $diagnosis_severity.css("border-color", "black");
        if (last_focus == "diagnosis_date") {chkErrors('diagnosis_date', 'focusout', $diagnosis_date, $form, last_focus);}
        if (last_focus == "past_treatment") {chkErrors('past_treatment', 'focusout', $past_treatment, $form, last_focus);}
