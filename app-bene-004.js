...
function submitButtonCheck() {
	checkAdditionalPolicyDetails(); // DELETE ONCE EVERYTHING REPLACED
	checkPrimaryBeneDetails();

	if ($bene_1_address.val() != '' &&
	    formattedAddress != '' &&
	    $bene_1_address_line1.val() != '' &&
	    $bene_1_city.val() != '' &&
	    $bene_1_state.val() != '' &&
	    $bene_1_zip.val() != '' &&
			conditionals_for_primary_bene_1_satisfied)
...
function checkPrimaryBeneDetails() {
	...
	if (primary_bene_selected == "Yes") {
			for (let x = 1; x < primary_bene_ct+1; x++) {
				if ( $('#bene_'+x+'_first_name').val() != ''
					&& $('#bene_'+x+'_last_name').val() != ''
					&& $('#bene'+x+'_dob').val() != ''
					&& $('#bene'+x+'_phone_number').val().length == 14
					&& $('#bene'+x+'_address').val() != ''
					&& $('#bene'+x+'_relationship').val() != ''
					&& ($('#bene'+x+'_allocation_percentage').val().length > 0 && $('#bene'+x+'_allocation_percentage').val().length < 4)
				) {
					switch (x) {
						case 1: conditionals_for_primary_bene_1_satisfied = true; break;
						case 2: conditionals_for_primary_bene_2_satisfied = true; break;
						case 3: conditionals_for_primary_bene_3_satisfied = true; break;
						case 4: conditionals_for_primary_bene_4_satisfied = true; break;
						case 5: conditionals_for_primary_bene_5_satisfied = true; break;
						default: break;
					}
				} else {
					switch (x) {
						case 1: conditionals_for_primary_bene_1_satisfied = false; break;
						case 2: conditionals_for_primary_bene_2_satisfied = false; break;
						case 3: conditionals_for_primary_bene_3_satisfied = false; break;
						case 4: conditionals_for_primary_bene_4_satisfied = false; break;
						case 5: conditionals_for_primary_bene_5_satisfied = false; break;
						default: break;
					}
				}
			}
			...
			if (conditionals_for_primary_bene_1_satisfied == false ||
...
function onPlaceChanged() {
  ...
  setTimeout(function() {
    ...
    if (addressSelectedWithMouse) {
      if (!active || active.id === 'bene_1_address' || active.tagName === 'BODY') {
...
$(function() {
	...
	(function($, window, document, undefined) {
      ...
      document.getElementById('submit_button').disabled = true;
		  ...
		  $bene_1_address.attr('autocomplete', 'off');
		  $bene_2_address.attr('autocomplete', 'off');
		  $bene_3_address.attr('autocomplete', 'off');
		  $bene_4_address.attr('autocomplete', 'off');
		  $bene_5_address.attr('autocomplete', 'off');
...
*/
      ...
      $bene_1_dob.mask('00/00/0000');
      $bene_2_dob.mask('00/00/0000');
      $bene_3_dob.mask('00/00/0000');
      $bene_4_dob.mask('00/00/0000');
      $bene_5_dob.mask('00/00/0000');

      $bene_1_phone_number.mask('(000) 000-0000');
      $bene_2_phone_number.mask('(000) 000-0000');
      $bene_3_phone_number.mask('(000) 000-0000');
      $bene_4_phone_number.mask('(000) 000-0000');
      $bene_5_phone_number.mask('(000) 000-0000');

			$bene_1_allocation_percentage.mask("##0%", {reverse: true});
			$bene_2_allocation_percentage.mask("##0%", {reverse: true});
			$bene_3_allocation_percentage.mask("##0%", {reverse: true});
			$bene_4_allocation_percentage.mask("##0%", {reverse: true});
			$bene_5_allocation_percentage.mask("##0%", {reverse: true});
      ...
      $bene_2_phone_number.on('input.True', function () {
        if ($(this).val().length > 14) {
          $(this).val($(this).val().slice(0, 14));
        }
      });
      $bene_3_phone_number.on('input.True', function () {
        if ($(this).val().length > 14) {
          $(this).val($(this).val().slice(0, 14));
        }
      });
      $bene_4_phone_number.on('input.True', function () {
        if ($(this).val().length > 14) {
          $(this).val($(this).val().slice(0, 14));
        }
      });
      $bene_5_phone_number.on('input.True', function () {
        if ($(this).val().length > 14) {
          $(this).val($(this).val().slice(0, 14));
        }
      });
			...
			function removePrimaryBene(i) {
				...
				switch (i) {
					case 1: conditionals_for_primary_bene_1_satisfied = true; 
								  ...
								  $("input[name='PrimaryBene'][value='No']").prop("checked", true);
									...
									$(".add_next_primary_bene").hide(500);
									conditionals_for_primary_bene_satisfied = true; break;
					case 2: conditionals_for_primary_bene_2_satisfied = true;
									$(".add_next_primary_bene").show(500); break;
					case 3: conditionals_for_primary_bene_3_satisfied = true;
									$(".add_next_primary_bene").show(500); break;
					case 4: conditionals_for_primary_bene_4_satisfied = true;
									$(".add_next_primary_bene").show(500); break;
					case 5: conditionals_for_primary_bene_5_satisfied = true;
									$(".add_next_primary_bene").show(500); break;
					default: break;
				}
				submitButtonCheck();
			...
			$('#add-next-primary-bene-button').click(function(e) {
				switch (primary_bene_ct) {
					case 0:
						...
						break;
					case 1: 
						$('#additional_primary_bene_2').show(500);
						primary_bene_ct = 2; 
						break;
					case 2: 
						$('#additional_primary_bene_3').show(500);
						primary_bene_ct = 3; 
						break;
					case 3: 
						$('#additional_primary_bene_4').show(500);
						primary_bene_ct = 4; 
						break;
					case 4: 
						$('#additional_primary_bene_5').show(500);
						primary_bene_ct = 5; 
						$(".add_next_primary_bene").hide(500); 
						break;
					default: primary_bene_ct = ""; 
						break;
				}
				conditionals_for_primary_bene_satisfied = false;
				submitButtonCheck();
      ...
      $bene_1_dob.on('input.True', function () {
				const dob = $(this).val();
				const isValidDate = /^(0[1-9]|1[0-2])\/(0[1-9]|[12]\d|3[01])\/\d{4}$/.test(dob);
				console.log("valid dob date check = "+isValidDate);
      ...
      $bene_1_dob.on('focusout', function () {
        if ($bene_1_dob.val().length < 11) {
          // if the DOB field is not full with a 8 digit number (plus the mask which provides slashes
          // between month and day, and day and year, throw up an error message that this field is required
          $('#error-bene-1-dob-required').show(500);
          $bene_1_dob.css('border-color', error_color);
        } else {
      ...
      if (window.location.search) {
        ...
        const primaryBeneficiariesDetails = getQueryParameter('primary_bene_details');
								...
								if (value) {
								    ...
								    if (match) {
								        const beneNumber = parseInt(match[1],10); // Extract the number from the key and ensure it is an integer
												if (!isNaN(beneNumber)) { // Double-check it's a valid number
														$('#additional_primary_bene_'+beneNumber).show(500);
														$(".add_next_primary_bene").show(500);
														primary_bene_ct = beneNumber;
										    } else {
										        console.error("Invalid primary beneficiary number extracted from key:", match[1]);
										    }
