...
console.log("IN BODY. BEFORE EVAL...height_inches.length="+height_inches.length+" | height_inches="+height_inches);
   				if (height_inches.length == 0) {height_inches = "0";}
console.log("IN BODY. AFTER EVAL...height_inches.length="+height_inches.length+" | height_inches="+height_inches);
  	...
  	if (page == "tobacco") {
        ...
        tobacco_errors = false;
				if (tobacco_selected != undefined && height_feet !='' && weight!='') {
console.log("IN TOBACCO. BEFORE EVAL...height_inches.length="+height_inches.length+" | height_inches="+height_inches);
   				if (height_inches.length == 0) {height_inches = "0";}
console.log("IN TOBACCO. AFTER EVAL...height_inches.length="+height_inches.length+" | height_inches="+height_inches);
					var risk = calcRisk(tobacco_selected, height_feet, height_inches, weight);
						storage.setItem('risk_class', risk.risk_class);
				}
