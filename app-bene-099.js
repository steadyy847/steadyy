    ...
    $(form).each(function () {
      ...
      $('.allocation-percentage').each(function () {
        ...
        $field.on('input', function () {
          let inputVal = $field.val();
          let raw = inputVal.replace(/\D/g, '').slice(0, 3);
          ...
          if (inputVal !== formatted) {
            ...
            // Update raw/num after setting the formatted value
            inputVal = $field.val();
            raw = inputVal.replace(/\D/g, '').slice(0, 3);
            num = parseInt(raw, 10);
