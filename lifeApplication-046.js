...
// START FOR TESTING A NEW BUNCH OF LOGIC ----------
				var other_insurance_selected = $("input[name='OtherLifeInsurance']:checked").val(),
			...
			if (other_insurance_selected == "Yes") {
					for (let x = 1; x < other_policy_ct+1; x++) {
						console.log("------ POLICY #"+x+" ------");
						console.log("other_carrier_"+x+" = "+$('#other_carrier_'+x).val()+"\n"+
												"other_policy_num_"+x+" = "+$('#other_policy_num_'+x).val()+"\n"+
												"other_policy_year_issued_"+x+" = "+$('#other_policy_year_issued_'+x).val()+"\n"+
												"other_policy_coverage_amt_"+x+" = "+$('#other_policy_coverage_amt_'+x).val()+"\n"+
												"policy-"+x+"-replacement-flag = "+$("input[name='policy-"+x+"-replacement-flag']").val()
						);
						if ( $('#other_carrier_'+x).val() != ''
							&& $('#other_policy_num_'+x).val() != ''
							&& $('#other_policy_year_issued_'+x).val() != ''
							&& $('#other_policy_coverage_amt_'+x).val() != ''
							&& $("input[name='policy-"+x+"-replacement-flag']").val() != null
						) {
							switch (x) {
							...
							switch (x) {
								case 1: conditionals_for_policy1_satisfied = false; conditionals_for_other_insurance_satisfied = false; break;
								case 2: conditionals_for_policy2_satisfied = false; conditionals_for_other_insurance_satisfied = false; break;
								case 3: conditionals_for_policy3_satisfied = false; conditionals_for_other_insurance_satisfied = false; break;
								case 4: conditionals_for_policy4_satisfied = false; conditionals_for_other_insurance_satisfied = false; break;
								case 5: conditionals_for_policy5_satisfied = false; conditionals_for_other_insurance_satisfied = false; break;
							}
						}

						switch (x) {
							case 1: console.log("conditionals_for_policy1_satisfied = "+conditionals_for_policy1_satisfied); break;
							case 2: console.log("conditionals_for_policy2_satisfied = "+conditionals_for_policy2_satisfied); break;
							case 3: console.log("conditionals_for_policy3_satisfied = "+conditionals_for_policy3_satisfied); break;
							case 4: console.log("conditionals_for_policy4_satisfied = "+conditionals_for_policy4_satisfied); break;
							case 5: console.log("conditionals_for_policy5_satisfied = "+conditionals_for_policy5_satisfied); break;
						}
					}
					console.log("conditionals_for_other_insurance_satisfied = "+conditionals_for_other_insurance_satisfied);
			}


// END FOR TESTING A NEW BUNCH OF LOGIC ----------
