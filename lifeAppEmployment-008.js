...
$(function() {
	...
	(function($, window, document, undefined) {
      ...
      if (address_line2.length > 0) {
			...
			$installment_debt.mask("#,##0", {reverse: true});
      ...
      $employer_address.on('input.True', function () {
        ...
        submitButtonCheck();
			...
			$personal_income.on('input focusout', function() {
			...
			$household_income.on('input focusout', function() {
			...
			$income_sources.on('change focusout', 'input, select, textarea', function() {
