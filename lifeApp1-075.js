    ...
    function parseAddress(formattedAddress) {
      ...
      geocoder.geocode({ address: formattedAddress }, function(results, status) {
        if (status === "OK" && results[0]) {
          ...
          console.log("BEFORE looping thru address to parse components:/n"+
                      "app_house_number = "+$('#app_house_number').val()+"/n"+
                      "app_street = "+$('#app_street').val()+"/n"+
                      "app_address_line1 = "+$('#app_address_line1').val()+"/n"+
                      "app_address_line2 = "+$('#app_address_line2').val()+"/n"+
                      "app_city = "+$('#app_city').val()+"/n"+
                      "app_state = "+$('#app_state').val()+"/n"+
                      "app_zip = "+$('#app_zip').val()
          );
          ...
          console.log("AFTER looping thru address to parse components:/n"+
                      "app_house_number = "+$('#app_house_number').val()+"/n"+
                      "app_street = "+$('#app_street').val()+"/n"+
                      "app_address_line1 = "+$('#app_address_line1').val()+"/n"+
                      "app_address_line2 = "+$('#app_address_line2').val()+"/n"+
