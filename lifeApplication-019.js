...
Webflow.push(function(){
	...
	$('#remove_policy_5').click(function(e) {
		...
		$('#other_carrier_5').val("");
		$('#other_carrier_5').removeClass('float');
		$('#other_policy_num_5').val("");
		$('#other_policy_num_5').removeClass('float');
		$('#other_policy_year_issued_5').val("");
		$('#other_policy_year_issued_5').removeClass('float');
		$('#other_policy_coverage_amt_5').val("");
		$('#other_policy_coverage_amt_5').removeClass('float');

		console.log("Policy 5 Replacement Flag (before resetting) = "+$("input[name='Policy 5 Replacement Flag']:checked").val());
	  ...
	  $("input[name='Policy 5 Replacement Flag'][value='No']").prop("checked", true);
		$("input[name='Policy 5 Replacement Flag'][value='No']").prev('.w-radio-input').addClass('w--redirected-checked');
		console.log("Policy 5 Replacement Flag (after resetting) = "+$("input[name='Policy 5 Replacement Flag']:checked").val());
