...
//        if (last_focus == "diagnosis_date") {chkAsthmaDetailErrors('diagnosis_date', 'focusout', object, $form, last_focus);}
        ...
        if (last_focus == "treatment") {chkAsthmaDetailErrors('treatment', 'focusout', object, $form, last_focus);}
        if (last_focus == "treatment_date") {chkAsthmaDetailErrors('treatment_date', 'focusout', object, $form, last_focus);}
        if (last_focus == "cpap") {chkAsthmaDetailErrors('cpap', 'focusout', object, $form, last_focus);}
        if (last_focus == "sleep_study") {chkAsthmaDetailErrors('sleep_study', 'focusout', object, $form, last_focus);}
        if (last_focus == "oxygen_saturation") {chkAsthmaDetailErrors('oxygen_saturation', 'focusout', object, $form, last_focus);}
        if (last_focus == "ahi") {chkAsthmaDetailErrors('ahi', 'focusout', object, $form, last_focus);}
        if (last_focus == "apnea_index") {chkAsthmaDetailErrors('apnea_index', 'focusout', object, $form, last_focus);}
        if (last_focus == "rdi") {chkAsthmaDetailErrors('rdi', 'focusout', object, $form, last_focus);}
...
//        if (last_focus == "sleep_study") {chkAsthmaDetailErrors('sleep_study', 'focusout', object, $form, last_focus);}
        ...
        if (last_focus == "apnea_index") {chkAsthmaDetailErrors('apnea_index', 'focusout', object, $form, last_focus);}
        if (last_focus == "rdi") {chkAsthmaDetailErrors('rdi', 'focusout', object, $form, last_focus);}
    if (objectAffected == 'oxygen_saturation') {
