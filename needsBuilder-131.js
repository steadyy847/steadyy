...
//			document.getElementById("return-step").disabled = true;
			...
			if (return_visit_selected == "Continue") {
					...
					switch (commit_point) {
						case "0-needs":
							storage_dependent_spouse = storage.getItem('dependent_spouse'),
				      ...
				      storage_current_insurance = storage.getItem('current_insurance');
							...
							// No need to check for goals, as if they haven't entered anything else, that's where to drop them anyway
			      	break;
			      case "1-basics":
...
//							nextPage = "/life-quote-referral";
					...
					if (nextPage !== undefined) {
							...
							console.log("commit_point = "+commit_point+" | nextPage = "+nextPage);
					}
			}
		}
	});
