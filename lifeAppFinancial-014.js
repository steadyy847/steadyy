...
function submitButtonCheck() {
	if (!financial_products_experience_errors &&
      ...
      document.getElementById('submit_button').disabled = true;
          ...
          // if there is something selected in this field, clear the error message
			...
			$financial_products_experience.on('focusout', function () {
				console.log("in the $financial_products_experience.on('focusout' function()");
			  ...
			  financialProductsFocusTimer = setTimeout(() => {
			    ...
			    if (!stillInside) {
						console.log("$('#experience-life-insurance-CB').prop('checked') = "+$('#experience-life-insurance-CB').prop('checked'));
						console.log("$('#experience-fixed-annuities-CB').prop('checked') = "+$('#experience-fixed-annuities-CB').prop('checked'));
						console.log("$('#experience-variable-annuities-CB').prop('checked') = "+$('#experience-variable-annuities-CB').prop('checked'));
						console.log("$('#experience-stocks-CB').prop('checked') = "+$('#experience-stocks-CB').prop('checked'));
						console.log("$('#experience-bonds-CB').prop('checked') = "+$('#experience-bonds-CB').prop('checked'));
						console.log("$('#experience-other-CB').prop('checked') = "+$('#experience-other-CB').prop('checked'));

					  if (life_insurance_experience && $years_of_life_insurance_experience.val().trim().length === 0) {
					  ...
					  if (fixed_annuities_experience && $years_of_fixed_annuities_experience.val().trim().length === 0) {
					  ...
					  if (variable_annuities_experience && $years_of_variable_annuities_experience.val().trim().length === 0) {
					  ...
					  if (stocks_experience && $years_of_stocks_experience.val().trim().length === 0) {
					  ...
					  if (bonds_experience && $years_of_bonds_experience.val().trim().length === 0) {
					  ...
					  if (other_experience && $years_of_other_experience.val().trim().length === 0) {
						...
						console.log("Getting ready to call validateFinancialProductsExperience(this)");
			      //validateFinancialProductsExperience(this); // Only validate once user has fully left
			    }
			  }, 10);
			});
