...
function dayValuesCheck(thisValue) {
  console.log("MONTH="+$('#dob_month').val());
  console.log("DAY="+thisValue);
  ...
  console.log("Fell thru checks for months with less than 31 days");
  /* Check That Day Doesn't Exceed 31 Days for All Other Months */
	if (this.value > 31 && this.value < 100) {
    console.log("In the IF clause of more than 31 days");
