...
////////////////////////////
			...
			function validateAnticipatedChanges() {
			  ...
			  if (anyChecked) {
			    // Apply checkbox styles and checked states
			    ids.forEach(id => {
			      const isChecked = document.getElementById(id).checked;
			      const $checkboxInput = $("#" + id);
			      const $visualBox = $checkboxInput.prev('.w-checkbox-input');

			      if (isChecked) {
			        $visualBox.addClass('w--redirected-checked');
			        //$checkboxInput.prop('checked', true);
			      } else {
			        $visualBox.removeClass('w--redirected-checked');
			    ...
			    // Special handling: if "no changes" is checked, uncheck the others
			    const isNoChangesChecked = document.getElementById('no-changes').checked;

			    console.log("isNoChangesChecked = " + isNoChangesChecked);
			    console.log("$('#no-changes').prop('checked') = " + $('#no-changes').prop('checked'));

			    if (isNoChangesChecked) {
			      ['income-change', 'living-expenses-change', 'assets-change', 'medical-expenses-change'].forEach(id => {
			        $('#' + id).prop('checked', false);
			        $('#' + id).prev('.w-checkbox-input').removeClass('w--redirected-checked');
			      });
			    }
